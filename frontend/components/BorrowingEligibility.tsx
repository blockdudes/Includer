    ...
    <div className="bg-card-background-gradient shadow-card-shadow p-4 rounded-lg">
      ...
      <div className="mt-4 p-4 bg-card-background-gradient shadow rounded-lg">
        ...
        <p className="text-sm text-white/90">
          ...
          are locked and will not be credited to your account even if your
          Super Savings matures. Upon repayment or term expiry, the remaining
          loan amount along with penalty for non-payment will be automatically
